...
Teaching will take place in-person, and will consist of self-studies (incl. independent work), group activities, lectures, and discussion seminars. The final session will take place online. 
The course is taught in English.


## Forms of examination

Active participation in all sessions and group assignments. A 3min final presentation summarizing the (future) implementation of Open Science principles in the participants’ own workflow.  
...
- Due to limited space the course can accommodate a maximum of 25 participants. If we receive more applications, participants will be selected based on selection criteria, including (but not limited to) correct entry requirements, motivation to attend the course, as well as geographical balance.   
